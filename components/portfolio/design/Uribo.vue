          ...
          >
            ...
            >
              <v-row class="pt-1">
                ...
                <v-col>
                  <strong>
                    ・自分のためでなく、ペットなど愛情を持つ対象のためなら頑張れる！<br>
                    ・いっしょにやる人がいれば楽しい！
                  </strong>
                  <div class="text-caption mb-2">
                    Hangouts
            ...
            >
              <v-row class="pt-1">
                ...
                <v-col>
                  <div class="text-caption">
                    定期的に時間を伝える時計 → <strong>インテリア</strong><br>
                  癒しを与える＆愛情を引き出す → <strong>ペット・弱いロボット</strong>
                  </div>
                  <strong>インテリアとペットが合わさった弱いロボットを作ろう！</strong>
                </v-col>
              </v-row>
            </v-timeline-item>
          </v-timeline>
